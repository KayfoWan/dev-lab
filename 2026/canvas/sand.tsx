    ...
    const animate = () => {
      ...
      for(let y = height - 1; y >= 0; y--) {
        for(let x = 0; x < width; x++) {
          ...
          const down = isEmpty(x, y + 1, grid) && isEmpty(x, y + 1, nextGrid);

          const dir = Math.random() < 0.5 ? 1 : -1;
          const diag1 = isEmpty(x + dir, y + 1, grid) && isEmpty(x + dir, y + 1, nextGrid);
          const diag2 = isEmpty(x - dir, y + 1, grid) && isEmpty(x - dir, y + 1, nextGrid);
